...
/*
 objc[61339]: Class AMSupportURLConnectionDelegate is implemented in both /usr/lib/libauthinstall.dylib (0x1ed91fb78) and /System/Library/PrivateFrameworks/MobileDevice.framework/Versions/A/MobileDevice (0x1202102b8). One of the two will be used. Which one is undefined.
objc[61339]: Class AMSupportURLSession is implemented in both /usr/lib/libauthinstall.dylib (0x1ed91fbc8) and /System/Library/PrivateFrameworks/MobileDevice.framework/Versions/A/MobileDevice (0x120210308). One of the two will be used. Which one is undefined.
